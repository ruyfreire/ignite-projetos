...
@Controller('/deliverymen/:cpf/password')
@AdminOnly()
export class UpdatePasswordDeliverymanController {
  constructor(
    private updatePasswordDeliverymanUseCase: UpdatePasswordDeliverymanUseCase,
  ) {}
  ...
  async handle(
    ...
    const result = await this.updatePasswordDeliverymanUseCase.execute({
      password,
      cpf,
    })
